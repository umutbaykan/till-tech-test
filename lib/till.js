class Till {
  ...
  static calculateBasketDiscount = (basket, totals, discount) => {
    if (discount.checkApplicable(basket, totals)) {
      return this.getDiscountPrice(totals.discountTotal, discount);
    } else {
